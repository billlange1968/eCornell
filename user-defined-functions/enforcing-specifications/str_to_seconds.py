...
def iso_8601(s):
    ...
    assert len(s) == 8, 'Precondition violation.'
...
def get_seconds(time):
    ...
    assert type(time) == str,'Precondition violation.'
    assert len(time) == 8, 'Precondition violation.'
    assert iso_8601(time), 'Precondition violation.'
